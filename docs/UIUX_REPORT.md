...
**Button Primary:** `bg-ink-900 → hover:bg-moni-600`, `rounded-full px-7 py-3.5`, `font-bold text-[18px]`, `shadow-lg shadow-ink-900/10`, icon `ArrowRight 3.5-4w`.
**Button Secondary:** `border-pink-100 bg-white hover:bg-moni-50`, same pill.
**Input:** `border-pink-100 bg-white px-4 py-3 text-[18px]`, `focus:border-moni-300 focus:ring-4 focus:ring-moni-50` - pink ring, not blue.
**Badge:** `rounded-full border-moni-100 bg-moni-50 px-2.5 py-1 text-[13px] font-bold text-moni-600`.
