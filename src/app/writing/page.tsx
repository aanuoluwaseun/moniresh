      ...
      <div className="flex-1 min-w-0 flex flex-col">
        ...
        <div className="flex-1 flex min-h-0 flex-col lg:flex-row">
          <div className="hidden lg:block w-[220px] border-r border-pink-50 bg-white p-4">
            <div className="text-[13px] font-bold tracking-widest uppercase text-black">Outline</div>
            <div className="mt-3 space-y-1 text-[16px] font-medium text-black">
            ...
            <div className="mt-6 rounded-xl bg-moni-50 border border-moni-100 p-3 text-[16px]">
          ...
          <div className="flex-1 bg-[#FFFEFE] flex items-center justify-center p-6 lg:p-10">
            <div className="w-full max-w-[680px] bg-white border border-pink-100 rounded-[20px] p-8 lg:p-9 text-center">
              ...
              <h2 className="mt-4 text-[20px] font-black">Your manuscript starts here</h2>
              <p className="text-[18px] text-black mt-1.5 font-medium leading-relaxed">Open a project and this becomes a calm editor - with your sources on the right. Every sentence can be opened to the papers behind it.</p>
              ...
              <div className="mt-6 flex justify-center gap-2">
                <Link href="/literature" className="rounded-full bg-ink-900 px-6 py-3 text-white text-[18px] font-bold">Create a project</Link>
                <Link href="/dashboard" className="rounded-full border border-pink-100 bg-white px-6 py-3 text-[18px] font-bold">Go to dashboard</Link>
              </div>
              <p className="text-[16px] text-black mt-4">This preview is empty until you write. No demo manuscript with fake results.</p>
            </div>
          </div>

          <div className="hidden xl:block w-[320px] border-l border-pink-50 bg-white p-4">
            <div className="text-[16px] font-black">Sources</div>
            <div className="mt-3 rounded-xl bg-moni-50 border border-moni-100 p-4 text-[18px] text-black">Add papers and your citations will appear here - linked to the exact sentence they support.</div>
          </div>
        </div>
      </div>
    </div>
