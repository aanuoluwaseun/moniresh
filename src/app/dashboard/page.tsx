        ...
        <header className="sticky top-0 z-20 bg-white/90 backdrop-blur border-b border-[#E2E8F0]">
          <div className="container-content !px-6 lg:!px-8 py-4 flex items-center justify-between">
            <div>
              ...
              <p className="text-[13px] text-[#64748B]">Your research, in one place.</p>
            </div>
        ...
        <main className="container-content !px-6 lg:!px-8 py-6 space-y-6">
          ...
          <div className="card p-5 flex flex-col md:flex-row gap-4 items-start justify-between">
            <div>
              ...
              <p className="text-[14px] text-[#64748B] mt-1">Open your literature, evidence, or manuscript. Everything stays linked.</p>
            ...
            <div className="text-[12px] text-[#64748B] border border-[#E2E8F0] rounded-[8px] px-3 py-2 bg-[#F8FAFC]">Evidence stays attached • Export anytime</div>
          </div>
          ...
          <section>
            ...
            {loading ? (
              ...
              <div className="mt-3 card p-8 text-center border-dashed">
                <div className="h-10 w-10 rounded-[10px] border border-[#E2E8F0] grid place-items-center mx-auto"><Sparkles className="h-4 w-4" /></div>
                <div className="font-medium mt-3">No projects yet</div>
                <p className="text-[14px] text-[#64748B] mt-1">Start with an idea, a PDF, or a draft.</p>
              ...
              <div className="mt-3 grid md:grid-cols-3 gap-3">
                {projects!.map(p => (
                  <Link key={p.id} href="/writing" className="card p-4 card-hover block">
                    ...
                    <div className="text-[13px] text-[#64748B] mt-1">Open <ArrowRight className="h-3 w-3 inline" /></div>
                  </Link>
                ))}
              </div>
            )}
