      ...
      <div className="flex-1 min-w-0 flex flex-col">
        ...
        <header className="sticky top-0 z-20 bg-white/80 backdrop-blur-xl border-b border-pink-50">
          <div className="px-6 lg:px-8 py-5">
            <h1 className="text-[22px] font-black tracking-tight flex items-center gap-2"><img src="/logo-moniresh-v2.png" alt="MONIRESH Logo" className="h-7 w-7 rounded-lg object-cover shadow-sm border border-pink-100 inline-block mr-2.5 -mt-1" /> <GraduationCap className="h-5 w-5 text-moni-500" /> Journals</h1>
        ...
        <PageTransition><main className="px-6 lg:px-8 py-8 max-w-[1080px] w-full mx-auto space-y-6">
          <div className="rounded-[24px] border border-pink-100 bg-white p-6 lg:p-7">
            ...
            <div className="mt-6 rounded-2xl border border-dashed border-pink-200 bg-[#FFFEFE] p-6 text-center">
              <div className="text-[18px] font-bold">No manuscript yet - no matches yet</div>
              <div className="text-[18px] text-black font-medium">Your suggestions will appear here once you have a title, abstract, and references.</div>
              <Link href="/writing" className="mt-4 inline-flex items-center gap-2 rounded-full bg-ink-900 px-5 py-2.5 text-white text-[18px] font-bold">Go to manuscript <ArrowRight className="h-4 w-4" /></Link>
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-4">
            <div className="rounded-[20px] border border-pink-100 bg-white p-6">
              ...
              <ul className="mt-3 space-y-1.5 text-[18px] font-medium text-black list-disc list-inside">
            ...
            <div className="rounded-[20px] border border-pink-100 bg-white p-6">
              ...
              <p className="text-[18px] text-black font-medium leading-relaxed">You won’t see a “94% fit” out of nowhere. When we can’t verify, we say so.</p>
