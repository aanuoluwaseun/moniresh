    ...
    <div className="min-h-screen bg-white text-[#1E293B]">
      ...
      <nav className="sticky top-0 z-40 bg-white/90 backdrop-blur border-b border-[#E2E8F0]">
        <div className="container-content h-[56px] flex items-center justify-between">
          <Link href="/" className="flex items-center gap-2">
            <div className="h-7 w-7 rounded-[8px] bg-[#4F46E5] text-white grid place-items-center font-bold text-[12px] tracking-tight">M</div>
          ...
          <div className="hidden md:flex items-center gap-6 text-[14px] text-[#1E293B]">
            <a href="#how" className="hover:text-[#1E293B]">How it works</a>
            <a href="#research" className="hover:text-[#1E293B]">Research</a>
      ...
      <section className="container-content pt-12 md:pt-20 pb-10">
        <div className="max-w-[720px]">
          <p className="text-[13px] tracking-wide text-[#64748B]">Research operating system for your papers</p>
          <h1 className="mt-3 text-[42px] md:text-[56px] font-semibold tracking-[-0.03em] leading-[0.95]">Your research, running<br />itself.</h1>
          <p className="mt-4 text-[17px] md:text-[18px] leading-[1.6] text-[#475569] max-w-[600px]">
          ...
          <p className="mt-3 text-[13px] text-[#64748B]">No credit card required. Set up in about 5 minutes. Review once a week.</p>
        </div>

        {/* Dashboard preview - unibeing style: hairline, numbers */}
        <div className="mt-10 card overflow-hidden">
          <div className="px-4 md:px-6 py-3 border-b border-[#E2E8F0] flex items-center justify-between">
            <span className="text-[13px] font-medium flex items-center gap-2"><span className="h-2 w-2 rounded-full bg-[#4F46E5]" /> moniresh — dashboard</span>
            <span className="text-[12px] text-[#64748B]">This week</span>
          </div>
          <div className="grid grid-cols-3 divide-x divide-[#E5E7EB] border-b border-[#E2E8F0]">
            {[
              ["3", "Projects"],
              ["18", "Papers"],
              ["2", "Drafts ready"],
          ...
          <div className="p-4 md:p-6">
            ...
            <div className="space-y-2">
              {[
                ...
                <div key={t} className="flex items-center justify-between rounded-[8px] border border-[#E2E8F0] px-4 py-3">
                  <div>
                    <div className="text-[14px] font-medium">{t}</div>
                    <div className="text-[13px] text-[#64748B]">{d}</div>
                  </div>
                  <span className="text-[12px] font-medium border border-[#E2E8F0] rounded-full px-2.5 py-1">{s}</span>
                </div>
              ))}
            </div>
          </div>
      ...
      <section className="hairline">
        <div className="container-content py-6 flex flex-col md:flex-row items-center justify-between gap-4">
          <span className="text-[13px] text-[#64748B]">Built for the sources you trust</span>
          <div className="flex flex-wrap gap-2 text-[12px] font-medium">
            {["OpenAlex", "Crossref", "PubMed", "Semantic Scholar", "Unpaywall"].map(s => (
              <span key={s} className="border border-[#E2E8F0] rounded-full px-3 py-1">{s}</span>
            ))}
          </div>
        </div>
      </section>
      ...
      <section className="container-content py-12 md:py-16">
        ...
        <p className="mt-2 text-[15px] text-[#475569] max-w-[640px]">Most tools make you do the work. They store what you've already found, but they don't help you find, appraise, or connect.</p>
        <div className="mt-6 grid md:grid-cols-2 gap-3 max-w-[720px]">
          {[
            ...
            <div key={t} className="flex items-center gap-2 text-[14px]"><span className="h-5 w-5 grid place-items-center rounded-full border border-[#E2E8F0] text-[#64748B]"><X className="h-3 w-3" /></span> {t}</div>
          ))}
        </div>
      </section>

      {/* Transformation */}
      <section className="hairline bg-[#F8FAFC]">
        <div className="container-content py-12 md:py-16 grid md:grid-cols-2 gap-8">
          <div>
            <h3 className="text-[18px] font-semibold">Before</h3>
            <p className="text-[14px] text-[#64748B] mt-1">You search, download, dedupe, extract, and reformat. Every week.</p>
            <ul className="mt-4 space-y-2 text-[14px] list-disc list-inside text-[#475569]">
          ...
          <div className="card p-6">
            ...
            <p className="text-[14px] text-[#64748B] mt-1">MONIRESH finds, links, and keeps evidence ready while you review in minutes.</p>
            <ul className="mt-4 space-y-2 text-[14px]">
              <li className="flex gap-2"><Check className="h-4 w-4 mt-0.5 text-[#1E293B]" /> A week of reading, traced to sources</li>
              <li className="flex gap-2"><Check className="h-4 w-4 mt-0.5 text-[#1E293B]" /> Approved claims stay linked</li>
              <li className="flex gap-2"><Check className="h-4 w-4 mt-0.5 text-[#1E293B]" /> Manuscript stays defensible</li>
            </ul>
          </div>
        </div>
      </section>
      ...
      <section id="how" className="container-content py-12 md:py-16">
        ...
        <div className="mt-8 grid md:grid-cols-4 gap-6">
          {[
            ...
            <div key={n} className="border border-[#E2E8F0] rounded-[12px] p-5 bg-white">
              <div className="h-7 w-7 grid place-items-center rounded-full bg-[#4F46E5] text-white text-[13px] font-semibold">{n}</div>
              <h3 className="mt-3 font-semibold text-[15px] leading-tight">{t}</h3>
              <div className="text-[12px] text-[#64748B] mt-1">{time}</div>
              <p className="text-[14px] text-[#475569] mt-2 leading-relaxed">{d}</p>
            </div>
          ))}
        </div>
      </section>
      ...
      <section className="hairline bg-[#F8FAFC]">
        <div className="container-content py-12 md:py-16">
          ...
          <p className="text-[14px] text-[#64748B] mt-1">The Evidence Chain is MONIRESH's signature — not a network graph, but a lineage.</p>
            ...
            <div className="flex items-center gap-2 min-w-[640px] text-[13px]">
              {["Claim", "Citation", "Paper", "Evidence", "Source"].map((s, i) => (
                <div key={s} className="flex items-center gap-2">
                  <span className="border border-[#E2E8F0] rounded-full px-3 py-1.5 bg-white font-medium">{s}</span>
                  {i < 4 && <span className="text-[#94A3B8]">→</span>}
                </div>
              ))}
            </div>
            <p className="text-[13px] text-[#64748B] mt-4">Click any node to see provenance: provider, DOI, timestamp. No invented citations.</p>
          </div>
        </div>
      </section>
        ...
        <div className="mt-6 grid md:grid-cols-3 lg:grid-cols-5 gap-4">
          {[
            ...
            <div key={t} className="card p-5">
              ...
              <div className="text-[13px] text-[#64748B] mt-1 leading-relaxed">{d}</div>
            </div>
          ))}
        </div>
      </section>
      ...
      <section className="hairline bg-[#F8FAFC]">
        <div className="container-content py-12 md:py-16 max-w-[720px] mx-auto">
          ...
          <div className="mt-6 divide-y divide-[#E5E7EB] border border-[#E2E8F0] rounded-[12px] bg-white">
            {[
              ...
              <details key={q} className="group px-5 py-4">
                <summary className="flex justify-between items-center cursor-pointer list-none font-medium text-[14px]">{q} <span className="text-[#64748B] group-open:rotate-45 transition">+</span></summary>
                <p className="text-[14px] text-[#475569] mt-2 leading-relaxed pr-6">{a}</p>
              </details>
            ))}
          </div>
        </div>
      ...
      <section className="container-content py-16 text-center">
        ...
        <p className="text-[15px] text-[#64748B] mt-2">No credit card required.</p>
        ...
        <div className="mt-8 flex justify-center gap-6 text-[13px] text-[#64748B]">
      ...
      <footer className="hairline py-6">
        <div className="container-content flex flex-col md:flex-row items-center justify-between gap-3 text-[13px] text-[#64748B]">
          ...
          <div className="flex gap-4">
            ...
            <a href="mailto:team@moniresh.ai" className="hover:text-[#1E293B]">team@moniresh.ai</a>
          </div>
        </div>
      </footer>
    </div>
